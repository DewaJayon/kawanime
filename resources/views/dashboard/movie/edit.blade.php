...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / Edit Movie / </span>{{ $movie->title }}</h4>
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('movie.update', $movie->slug) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Judul Movie" name="title"
                                ...
                                <div class="col-md-12">
                                    <select class="form-select @error('genre') is-invalid @enderror" id="multiple-select-field" data-placeholder="Pilih Genre" multiple name="genre[]">
                                        @foreach ($genres as $genre)
                                            @if ($genre->genreOption->where('movie_id', $movie->id)->count() > 0)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <input id="description" type="hidden" name="description" value="{{ old('description', $movie->description) }}">
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="hidden" name="old_video" value="{{ $movie->video }}">
                                ...
                                <div class="col-lg-3">
                                    @if ($movie->video != null)
                                        <video src="{{ asset('storage/' . $movie->video) }}" id="video-preview" class="img-thumbnail"></video>
                                    @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    @if ($movie->thumbnail != null)
                                        <img src="{{ asset('storage/' . $movie->thumbnail) }}" id="img-preview" class="img-thumbnail" id="img-preview" alt="Image">
                                    @else
