                    ...
                    <div class="card-body">
                        <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('title') is-invalid @enderror" type="text" value="{{ old('title') }}" id="title" name="title" placeholder="Judul">
                                    @error('title')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('url') is-invalid @enderror" type="url" value="{{ old('url') }}" id="url" name="url" placeholder="URL">
                                    @error('url')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-select @error('category') is-invalid @enderror" id="category" aria-label="Pilih Category" name="category">
