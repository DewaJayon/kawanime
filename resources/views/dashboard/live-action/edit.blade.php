...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / Edit Live Action / </span>{{ $liveAction->title }}</h4>
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Live Action</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('live-action.update', $liveAction->slug) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="mb-3">
                                <label class="form-label" for="title">Title</label>
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Judul Live Action" name="title"
                                    value="{{ old('title', $liveAction->title) }}">
                                @error('title')
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('release_date') is-invalid @enderror" id="release_date" name="release_date"
                                            value="{{ old('release_date', Carbon\Carbon::parse($liveAction->release_date)->format('Y-m-d')) }}">
                                        @error('release_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('duration') is-invalid @enderror" id="duration" placeholder="Masukkan Durasi" name="duration"
                                            value="{{ old('duration', $liveAction->duration) }}">
                                        @error('duration')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <select class="form-select" id="category_id" aria-label="Pilih Category" name="category_id">
                                        <option hidden>Pilih Category</option>
                                        @foreach ($categories as $category)
                                            @if (old('category_id', $liveAction->category_id) == $category->id)
                                ...
                                <div class="col-md-12">
                                    <select class="form-select @error('genre') is-invalid @enderror" id="multiple-select-field" data-placeholder="Pilih Genre" multiple name="genre[]">
                                        @foreach ($genres as $genre)
                                            @if ($genre->genreOption->where('live_action_id', $liveAction->id)->count() > 0)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <input id="description" type="hidden" name="description" value="{{ old('description', $liveAction->description) }}">
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="hidden" name="old_video" value="{{ $liveAction->video }}">
                                ...
                                <div class="col-lg-3">
                                    @if ($liveAction->video != null)
                                        <video src="{{ asset('storage/' . $liveAction->video) }}" id="video-preview" class="img-thumbnail"></video>
                                    @else
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="hidden" name="old_thumbnail" value="{{ $liveAction->thumbnail }}">
                                ...
                                <div class="col-lg-3">
                                    @if ($liveAction->thumbnail != null)
                                        <img src="{{ asset('storage/' . $liveAction->thumbnail) }}" id="img-preview" class="img-thumbnail" id="img-preview" alt="Image">
                                    @else
                ...
                $('form').ajaxForm({
                    ...
                    complete: function(xhr) {
                        if (xhr.status === 200) {
                            Swal.fire({
                                title: "Success",
                                text: "Live Action Berhasil Di Edit",
                                icon: "success",
                            });
